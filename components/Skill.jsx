    ...
    <div className="group relative flex cursor-pointer">
      ...
      >
        <SiFirebase
          ...
          xl:h-26 xl:w-26 filter group-hover:bg-gray-500 transition duration-300 ease-in-out"
        />
      </motion.div>
      <div
        className="absolute opacity-0 group-hover:opacity-80 transition duration-300 ease-in-out 
      group-hover:bg-white h-20 w-20 md:h-24 md:w-24 xl:h-26 xl:w-26 rounded-full z-0"
      >
