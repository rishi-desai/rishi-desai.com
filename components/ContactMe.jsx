...
function ContactMe() {
  ...
  const onSubmit = (formData) => {
    window.location.href = `mailto:rishidesai@gatech.edu?subject=${formData.subject}&body=
  ...
  px-10 justify-evenly mx-auto items-center"
    >
      ...
      <div className="flex flex-col space-y-10 font-chivomonoreg">
        ...
        <div className="space-y-10">
          ...
          <div className="flex items-center space-x-5 justify-center">
            ...
            <p className="text-xl">rishidesai@gatech.edu</p>
          </div>
        </div>
